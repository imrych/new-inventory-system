...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $insert_sql = "INSERT INTO `order` (product, brand, category, size, quantity, price, staff, order_date) 
                   VALUES ('$product_id', '$brand_name', '$cat_id', '$size', '$quantity', '$price', '$staff', '$order_date')";
