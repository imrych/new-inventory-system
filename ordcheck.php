...
<head>
    ...
    <script>
        ...
        function editOrder(order_id, status) {
            if (status !== 'delivered') {
                window.location.href = "editorder_check.php?id=" + order_id;
            } else {
        ...
        function deleteOrder(order_id) {
            if (confirm("Are you sure you want to delete this order?")) {
                window.location.href = "deleteord_checker.php?id=" + order_id;
            }
        }
    </script>
</head>
    ...
    <div class="group_names">
        <div class="group_content">
            <div class="title_and_button">
                <h2>Orders</h2>
                <button type="button" onclick="location.href='addorder_checker.php'">Add New Order</button>
            </div>
