...
<div class="table-container">
    <div class="title_and_button">
        <h2>Suppliers</h2>
        <button type="button" onclick="location.href='addsup_check.php'">Add New Supplier</button>
    </div>
    <?php
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<td>
                <button onclick=\"window.location.href='editsupp_check.php?id=" . $row["sup_id"] . "'\" style=\"margin-right: 0px; padding: 3px 9px; font-weight: bold; border-radius: 4px; background-color: #F59607; color: #ffffff; border: none;\">
...
<script>
    function deleteSupplier(id) {
        if (confirm("Are you sure you want to delete this supplier?")) {
            window.location.href = 'suppcheck.php?action=delete&id=' + id;
        }
    }
</script>
</body>
